...
public class PrivateBrowsingShieldOverride {
    ...
    public var overrides: [DissenterShield: Bool] = [:]
    
    public init(shield: DissenterShield, isOn: Bool) {
        overrides[shield] = isOn
    }
    
    public subscript(shield: DissenterShield) -> Bool? {
