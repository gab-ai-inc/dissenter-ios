...
open class DissenterGlobalShieldStats {
    public static let shared = DissenterGlobalShieldStats()
    public static let DidUpdateNotification = "DissenterGlobalShieldStatsDidUpdate"
    ...
    private func postUpdateNotification() {
        NotificationCenter.default.post(name: Notification.Name(rawValue: DissenterGlobalShieldStats.DidUpdateNotification), object: nil)
    }
