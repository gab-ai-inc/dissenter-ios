...
extension Strings {
    ...
    public static let TabToolbarSearchAddressPlaceholderText = NSLocalizedString("TabToolbarSearchAddressPlaceholderText", tableName: "DissenterShared", bundle: Bundle.dissenterShared, value: "Search or type a URL", comment: "The text shown in the URL bar on about:home")
...
extension Strings {
    ...
    public static let Private_Browsing = NSLocalizedString("PrivateBrowsing", tableName: "DissenterShared", bundle: Bundle.dissenterShared, value: "Private Browsing Enabled", comment: "")
}
...
extension Strings {
    ...
    public static let Help = NSLocalizedString("Help", tableName: "DissenterShared", bundle: Bundle.dissenterShared, value: "Help", comment: "Show Dissenter Help page from the Support section in the settings.")
    ...
    public static let Site_shield_settings = NSLocalizedString("SiteShieldSettings", tableName: "DissenterShared", bundle: Bundle.dissenterShared, value: "Dissenter Website Shields", comment: "Dissenter panel topmost title")
    ...
    public static let Shields_Overview = NSLocalizedString("ShieldsOverview", tableName: "DissenterShared", bundle: Bundle.dissenterShared, value: "Dissenter Website Shields allow you to control when ads and trackers are blocked for each website that you visit.", comment: "shields overview message")
