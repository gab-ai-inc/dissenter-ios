...
public struct DissenterUX {    
    public static let DissenterPrivacyURL = URL(string: "https://www.dissenter.com/about/privacy-policy")!
    public static let DissenterTermsOfUseURL = URL(string: "https://www.dissenter.com/about/terms-of-use")!
    ...
    public static let DissenterGreen = UIColor(rgb: 0x00d177)
    ...
    public static let DissenterButtonMessageInUrlBarColor = DissenterGreen
    public static let DissenterButtonMessageInUrlBarShowTime = 0.5
    public static let DissenterButtonMessageInUrlBarFadeTime = 0.7
